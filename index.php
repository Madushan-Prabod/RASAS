...
<head>
  ...
  <style>
    ...
    .text-contain {
      position: relative;
      padding: 20px;
      background-color: #800020 border-radius: 10px;
      text-align: center;
      margin-top: 50px;
    }
    ...
    .wave:nth-child(2) {
      ...
      animation: wave-animation 5s infinite linear reverse;
    }
    ...
    .wave-container {
      animation: fill-animation 5s ease-in-out forwards;
    }
...
<body>
  ...
  <div id="loadingOverlay" class="loading-overlay">
    <div id="logoContainer" class="logo-container">
      <img src="asserts/images/hss.png" alt="Company Logo" class="logo-image">
    </div>
    <div class="text-contain">
      <p class="loading-text">Ruhuna Arts Student's Annual Sessions</p>
      <p class="additional-text">Faculty of Humanities and Social Sciences</p>
      <p class="additional-text">University of Ruhuna</p>
    </div>
  </div>
  ...
  <di id="content" style="display: none;">
    ...
    <div class="row" style="background-color: #A52A2A; color: #FFC300;">
      <div class="col-md-3 border border-light border-end">
        <br>
        <?php
    ...
    <!--footer-->
    <footer>
            <div class="footer-content" style="position: relative; z-index: 30;">
