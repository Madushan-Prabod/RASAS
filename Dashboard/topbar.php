...
<ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="user_profile.php" id="userDropdown" role="button"
            ...
            ?>
            <span
                class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $row['full_name']; ?></span>
            <img class="img-profile rounded-circle" src="profile_pic/<?php echo $row['user_pic']; ?>">
        </a>
